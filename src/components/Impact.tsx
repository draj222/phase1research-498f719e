...
const Counter = ({ value, className, inView }: { value: string; className?: string; inView: boolean }) => {
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-3xl md:text-4xl font-bold text-white mb-2">
                  <Counter value={stat.number.replace('+', '')} inView={isInView} />
